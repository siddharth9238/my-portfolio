...
const PROFILE_PATH = '/assets/Pp1.jpeg';

useGLTF.preload(GLTF_PATH);
useTexture.preload(TEXTURE_PATH);
useTexture.preload(PROFILE_PATH); 
...
function Band({ isMobile, maxSpeed = 50, minSpeed = 10 }) {
  ...
  // ==========================================
  const profileTexture = useTexture(PROFILE_PATH);
  profileTexture.flipY = false;
  
  // SLIDE THE IMAGE: 
  // Change "0.25" if the face isn't perfectly centered. 
  // Try 0.1, 0.3, or even negative numbers like -0.1
  profileTexture.offset.set(0.25, 0); 

  // OPTIONAL ZOOM:
  // If the image looks too stretched, uncomment the line below to scale it
        ...
        >
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial {...materials.base} map={profileTexture} />
            </mesh>
