...
const socialLinks = [
  {
    title: 'Email',
    user: 'singhsiddharth9238@gmail.com', // Write your actual email here
    icon: FaEnvelope,
    link: 'mailto:singhsiddharth9238@gmail.com', // Must start with mailto:
  },
  {
    title: 'Instagram',
    user: '@__siddharth.singh__',
    icon: FaInstagram,
    link: 'https://www.instagram.com/__siddharth.singh__?igsh=MmJsYjk2aDIzcHd4',
  },
  {
    title: 'Youtube',
    user: '@sidharthsingh1181',
    icon: FaYoutube,
    link: 'https://youtube.com/@sidharthsingh1181?si=rCwRSeEBOfI9E9Ao',
  },
  {
    title: 'Github',
    user: '@siddharth9238',
    icon: FaGithub,
    link: 'https://github.com/siddharth9238',
  },
  {
    title: 'Leetcode',
  user: '@siddharth6634', 
  icon: SiLeetcode,
  link: 'https://leetcode.com/u/siddharth6634/', 
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        <motion.a
          href="https://www.linkedin.com/in/siddharth-singh-3241b8241"  
          target="_blank"
